              ...
              <ul class="navbar-nav  mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#">Artesanatos</a></li>
                ...
                <li class="nav-item">
                  <a style="color: white;" class="nav-link" href="#">Contactos</a>
                </li>
                <li class="nav-item">
                  <a style="color: white;" class="nav-link" href="#">Minha Conta</a>
                </li>
              </ul>
            </div>
            <div class="d-flex ">
